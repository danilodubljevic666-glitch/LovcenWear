...
const heroShirts = [
  { src: '/majice/20 godina premium majica/20 godina crvena.png', alt: '20 godina premium majica', direction: 'left',  imgScale: 'scale-[0.935] translate-y-[20px] lg:translate-y-0' },
